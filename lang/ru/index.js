var langStr={
	HELP:'Справка',
	ACTIONS:'Режимы',
	ACT_SAVE:'Сохранять режимы и положение',
	...
	<br>---Действия<br> \
	Опция Сохранять режимы и положение - сохраняет некоторые опции (пока что перемещение кнопками и молодые номера сверху), а главное сохранение положения карты: \
	сохраняет при перезагрузке или закрытии окна, при включенной опции, при выключенной - сбрасывает \
	<br> \
